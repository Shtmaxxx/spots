...
import '../../flows/main/domain/usecases/send_message.dart' as _i32;
...
import 'injectible_init.dart' as _i41; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i31.MapCubit>(() => _i31.MapCubit(
        getMarkers: get<_i28.GetMarkersUseCase>(),
        joinChatGroup: get<_i30.JoinChatGroupUseCase>(),
      ));
  gh.factory<_i32.SendMessageUseCase>(
      () => _i32.SendMessageUseCase(get<_i25.ChatsRepositoryI>()));
  gh.factory<_i33.SignInUseCase>(
      () => _i33.SignInUseCase(get<_i22.AuthRepositoryI>()));
  gh.factory<_i34.SignOutUseCase>(
      () => _i34.SignOutUseCase(get<_i22.AuthRepositoryI>()));
  gh.factory<_i35.SignUpUseCase>(
      () => _i35.SignUpUseCase(get<_i22.AuthRepositoryI>()));
  gh.factory<_i36.AppStateCubit>(() => _i36.AppStateCubit(
        authRepository: get<_i20.AuthRepositoryI>(),
        firebaseAuth: get<_i5.FirebaseAuth>(),
      ));
  gh.factory<_i37.ChatsCubit>(
      () => _i37.ChatsCubit(get<_i29.GetUsersChatsUseCase>()));
  gh.factory<_i38.MessagesCubit>(() => _i38.MessagesCubit(
        get<_i27.GetChatMessagesUseCase>(),
        get<_i32.SendMessageUseCase>(),
      ));
  gh.factory<_i39.SignInCubit>(
      () => _i39.SignInCubit(get<_i33.SignInUseCase>()));
  gh.factory<_i40.SignUpCubit>(
      () => _i40.SignUpCubit(get<_i35.SignUpUseCase>()));
  return get;
}
